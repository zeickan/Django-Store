...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayPalNVP.transactionid'
        db.add_column('paypal_nvp', 'transactionid', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PayPalNVP.transactionid'
        db.delete_column('paypal_nvp', 'transactionid')
