...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PayPalNVP', fields ['invnum']
        db.create_index('paypal_nvp', ['invnum'])

        # Adding index on 'PayPalNVP', fields ['custom']
        db.create_index('paypal_nvp', ['custom'])


    def backwards(self, orm):
        
        # Removing index on 'PayPalNVP', fields ['custom']
        db.delete_index('paypal_nvp', ['custom'])

        # Removing index on 'PayPalNVP', fields ['invnum']
        db.delete_index('paypal_nvp', ['invnum'])
    ...
    models = {
        ...
        'pro.paypalnvp': {
            ...
            'custom': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invnum': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            ...
            'transactionid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
