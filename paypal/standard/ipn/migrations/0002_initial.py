...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paypal_ipn', (
            ...
            ('parent_txn_id', self.gf('django.db.models.fields.CharField')(max_length=19, blank=True)),
            ...
            ('test_ipn', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('verify_sign', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('payer_business_name', self.gf('django.db.models.fields.CharField')(max_length=127, blank=True)),
            ...
            ('auth_amount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('auth_exp', self.gf('django.db.models.fields.CharField')(max_length=28, blank=True)),
            ('auth_id', self.gf('django.db.models.fields.CharField')(max_length=19, blank=True)),
            ('auth_status', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
            ('exchange_rate', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=16, blank=True)),
            ('invoice', self.gf('django.db.models.fields.CharField')(max_length=127, blank=True)),
            ...
            ('mc_handling', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('mc_shipping', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('memo', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('num_cart_items', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('option_name1', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('option_name2', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('payer_status', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ...
            ('pending_reason', self.gf('django.db.models.fields.CharField')(max_length=14, blank=True)),
            ('protection_eligibility', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('reason_code', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('remaining_settle', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('settle_amount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('settle_currency', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('shipping', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('shipping_method', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('tax', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('transaction_entity', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('auction_buyer_id', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('auction_closing_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('auction_multi_item', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('for_auction', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ...
            ('amount1', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('amount2', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('amount3', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('mc_amount1', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('mc_amount2', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('mc_amount3', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=24, blank=True)),
            ('period1', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('period2', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('period3', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('reattempt', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('recur_times', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('recurring', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('retry_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('subscr_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('subscr_effective', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('subscr_id', self.gf('django.db.models.fields.CharField')(max_length=19, blank=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('case_creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('case_id', self.gf('django.db.models.fields.CharField')(max_length=14, blank=True)),
            ('case_type', self.gf('django.db.models.fields.CharField')(max_length=24, blank=True)),
            ('receipt_id', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('currency_code', self.gf('django.db.models.fields.CharField')(default='USD', max_length=32, blank=True)),
            ('handling_amount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('transaction_subject', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
